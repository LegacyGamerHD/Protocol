...
import com.nukkitx.protocol.bedrock.beta.serializer.*;
...
public class BedrockBeta {
    public static BedrockPacketCodec BETA_CODEC = BedrockPacketCodec.builder()
            ...
            .registerPacket(PlayerActionPacket.class, PlayerActionSerializerBeta.INSTANCE, 36)
            ...
            .registerPacket(LessonProgressPacket.class, LessonProgressSerializerBeta.INSTANCE, 183)
            .registerPacket(RequestAbilityPacket.class, RequestAbilitySerializerBeta.INSTANCE, 184)
            .registerPacket(RequestPermissionsPacket.class, RequestPermissionsSerializerBeta.INSTANCE, 185)
            .registerPacket(ToastRequestPacket.class, ToastRequestSerializerBeta.INSTANCE, 186)
            .build();
}
